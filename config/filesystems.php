    ...
    */
    ...
    'disks' => [
        ...
        'qiniu' => [
            'driver'  => 'qiniu',
            'domains' => [
                'default'   => 'tv.longdawenhua.cn', //你的七牛域名
                'https'     => 'dn-yourdomain.qbox.me',         //你的HTTPS域名
                'custom'    => 'static.abc.com',                //Useless 没啥用，请直接使用上面的 default 项
            ],
            'access_key'=> 'FBH-8AQ9iP6ZZysz1xz0sAB7ejGUf-vEyNbzMZsD',  //AccessKey
            'secret_key'=> 'RR7DbNd-W5k1Lt7mSZgr6ZmAF0-Hc2e-6hDDV9wd',  //SecretKey
